 ...
 *
 * Note, that list might be incomplete, as it is missing Application Load Balancer.
 * https://docs.aws.amazon.com/elasticloadbalancing/latest/application/lambda-functions.html
 *
 * For how to parse from a map, see sample events published by event source.
...
final class EventSourceParser {
    ...
    private static String parseS3BucketArn(Object object) {
        ...
        final S3EventNotification.S3EventNotificationRecord s3EventNotificationRecord = notification.getRecords().get(0);
    ...
    private static String parseAPIGatewayProxyRequestEventUserArn(Object object) {
        final APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent = (APIGatewayProxyRequestEvent) object;

        final APIGatewayProxyRequestEvent.ProxyRequestContext requestContext = apiGatewayProxyRequestEvent.getRequestContext();
