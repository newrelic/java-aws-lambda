...
public class TracingRequestHandlerTest {
    ...
    public void testS3Event() {
        ...
        final S3EventNotification.UserIdentityEntity userIdentity = new S3EventNotification.UserIdentityEntity("principalId");
        final S3EventNotification.S3BucketEntity s3BucketEntity = new S3EventNotification.S3BucketEntity("bucketName", userIdentity, "s3ARN");
        final S3EventNotification.S3Entity s3Entity = new S3EventNotification.S3Entity("s3Entity", s3BucketEntity, null, null);
        final S3EventNotification.S3EventNotificationRecord record = new S3EventNotification.S3EventNotificationRecord("awsRegion", "eventName", "eventSource",
                "2010-06-30T01:20+02:00", "eventVersion", null, null, s3Entity, null);
        records.add(record);
    ...
    public void testKinesisStreamEvent() {
        final MyKinesisStreamRequestHandler myKinesisStreamRequestHandler = new MyKinesisStreamRequestHandler();
        ...
        final MockSpan span = mockTracer.finishedSpans().get(0);
        Assert.assertEquals("KinesisStreamEventSourceARN", span.tags().get("aws.lambda.eventSource.arn"));
    }

    @Test
    public void testKinesisFirehoseEvent() {
        final MyKinesisFirehoseRequestHandler myKinesisFirehoseRequestHandler = new MyKinesisFirehoseRequestHandler();
        ...
        final MockSpan span = mockTracer.finishedSpans().get(0);
        Assert.assertEquals("KinesisFirehoseDeliveryStreamArn", span.tags().get("aws.lambda.eventSource.arn"));
    }
    ...
    public void testAPIGatewayProxyRequestEvent() {
        final MyApiGatewayProxyRequestHandler myApiGatewayProxyRequestHandler = new MyApiGatewayProxyRequestHandler();

        final APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent = new APIGatewayProxyRequestEvent();
        final APIGatewayProxyRequestEvent.RequestIdentity requestIdentity = new APIGatewayProxyRequestEvent.RequestIdentity();
        requestIdentity.setUserArn("APIGatewayProxyRequestEventUserARN");
        final APIGatewayProxyRequestEvent.ProxyRequestContext proxyRequestContext = new APIGatewayProxyRequestEvent.ProxyRequestContext();
        ...
        final MockSpan span = mockTracer.finishedSpans().get(0);
        Assert.assertEquals("APIGatewayProxyRequestEventUserARN", span.tags().get("aws.lambda.eventSource.arn"));
    }
...
//        final MockSpan span = mockTracer.finishedSpans().get(0);
//        Assert.assertEquals("CloudWatchLogsEventSourceARN", span.tags().get("aws.lambda.eventSource.arn"));
//    }
...
//        final MockSpan span = mockTracer.finishedSpans().get(0);
//        Assert.assertEquals("CloudFrontEventEventSourceARN", span.tags().get("aws.lambda.eventSource.arn"));
//    }
    ...
    // Kinesis Stream
    static class MyKinesisStreamRequestHandler implements TracingRequestHandler<KinesisEvent, Object> {
        @Override
    ...
    // Kinesis Firehose
    static class MyKinesisFirehoseRequestHandler implements TracingRequestHandler<KinesisFirehoseEvent, Object> {
        @Override
    ...
    // Code Commit
    static class MyCodeCommitRequestHandler implements TracingRequestHandler<CodeCommitEvent, Object> {
        @Override
    ...
    static class MyApiGatewayProxyRequestHandler implements TracingRequestHandler<APIGatewayProxyRequestEvent, Object> {
        @Override
        public Object doHandleRequest(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent, Context context) {
            return "null";
        }
    }

    // Cloud Front
    static class MyCloudFrontRequestHandler implements TracingRequestHandler<CloudFrontEvent, Object> {
        @Override
    ...
    // Cloud Watch
    static class MyCloudWatchRequestHandler implements TracingRequestHandler<CloudWatchLogsEvent, Object> {
        @Override
